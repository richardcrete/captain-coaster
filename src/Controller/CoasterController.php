...
class CoasterController extends BaseController
{
    ...
    public function ajaxLoadReviews(Request $request, RiddenCoasterRepository $riddenCoasterRepository, PaginatorInterface $paginator, #[MapEntity(mapping: ['slug' => 'slug'])] Coaster $coaster, #[MapQueryParameter] int $page, #[MapQueryParameter] array $filters = []): Response
    {
        $user = $this->getUser();
